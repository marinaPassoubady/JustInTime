...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Shangavi SRIKARAN</span>
            </a>
            <ul class="dropdown-menu">
  ...
  <aside class="main-sidebar">
    ...
    <!-- /.sidebar -->
	          <div id="w">
    <div id="content">
      <a href="#loginmodal" class="flatbtn" id="modaltrigger" style="font-size: 10px;">Ajouter une tache</a>
    </div>
  </div>
  </aside>
...
<script>
  ...
  <div id="loginmodal" style="display:none;">
    ...
    <form id="loginform" name="loginform" method="post" action="CreerTache">
      ...
      <div class="center"><input type="submit" name="tachebtn" id="tachebtn" class="flatbtn-blu hidemodal" value="Creer la tache" tabindex="7"></div>
    </form>
  </div>
